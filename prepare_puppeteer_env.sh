...
# Update apt list and install common fonts and libraries required by browsers
...
if [ -n "$chrome_path" ]; then
    ...
    cp "$chrome_path" ./google-chrome-stable
    echo "INFO: Copied executable to ./google-chrome-stable"
